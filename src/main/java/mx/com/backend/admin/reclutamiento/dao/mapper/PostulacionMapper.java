...
public class PostulacionMapper implements RowMapper<Postulacion> {

	@Override
	public Postulacion mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		postulacion.setTotalCandidatos(rs.getInt("total_usuarios"));
